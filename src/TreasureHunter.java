...
public class TreasureHunter {
    ...
    private void welcomePlayer() {
        ...
        System.out.print("Enter mode(e or n or h): ");
        ...
        if (hard.equals("h")) {
            ...
            System.out.println("you didnt put in a valid option so we gave you normal mode");
    ...
    private void enterTown() {
        ...
        currentTown = new Town(shop, toughness, easyMode, samuraiMode);
    ...
    private void showMenu() {
        String choice = "";
        while (!choice.equals("x") && hunter.getGold()>=0 && hunter.getIdx()<3) {
            System.out.println();
        ...
        } else if (hunter.getIdx() == 3){
            System.out.println("YOU WON!!! You found all of the treasure");
        }
    }
